        ...
        <div className="pointer-events-none fixed bottom-16 right-4 z-50 flex flex-col items-end gap-3 md:hidden">
            <div className="pointer-events-auto flex flex-col items-end gap-3">
                    ...
                    <div className="flex w-full flex-col items-end gap-3">
                        {actions.map(({ label, icon: Icon, actionKey }) => (
                            <button
                                ...
                                className="glass group inline-flex items-center gap-3 rounded-full px-4 py-3 text-sm font-medium text-slate-800 transition-all duration-200 hover:-translate-y-0.5 hover:bg-emerald-50 active:scale-95 dark:text-slate-100"
                            >
                ...
                <button
                    ...
                    className="pointer-events-auto inline-flex h-14 w-14 items-center justify-center rounded-full border border-white/40 bg-gradient-to-b from-emerald-500 to-emerald-700 text-white shadow-lg transition-transform duration-300 ease-out hover:bg-emerald-500 active:scale-95"
