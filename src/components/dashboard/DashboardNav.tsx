    ...
    <header className="glass sticky top-0 z-50 border-b border-white/20 dark:border-slate-700/50">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-3 sm:px-6 lg:px-8">
        <div className="flex items-center gap-2 sm:gap-3">
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 sm:h-10 sm:w-10">
            <UtensilsCrossed className="h-4 w-4 text-white sm:h-5 sm:w-5" />
          </div>
